...
function Part(x, y, z) {
  ...
  this.rot = new Obj();
  this.vel = new Obj();
  this.col = 'hsla(50, 87%, 74%,'+rnd(0.5, 1)+')';
}
...
function draw() {
  ...
  $.font = "4em Pretendard-Regular";
  $.fillStyle = 'hsla(216,95%,85%,.7)';
  $.textBaseline = 'middle';
...
function run() {
  ...
  g_.addColorStop(0.5, 'hsla(197, 57%, 16%, 1)');
  g_.addColorStop(0.8, 'hsla(197, 93%, 11%, 1)');
